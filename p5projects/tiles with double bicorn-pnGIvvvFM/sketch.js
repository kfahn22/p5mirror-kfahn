// L-system tiles rule from Paul Bourke
...
let sentence;
let fractal;
let shapeScale = 0.5; //  set shape length to fraction of step length
let palette;
let url;
...
function setup() {
  ...
  selectedShape = new Shape(0, 0, shapeScale*length, 1, 1, 1, 1, 1, 1, 1, radians(180));
...
function reset() {
  ...
  selectedShape = new Shape(0, 0, length * shapeScale, 1,1,1,1,1, radians(180));
