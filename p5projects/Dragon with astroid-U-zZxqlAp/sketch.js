// L-system dragon rule slightly edited from Paul Bourke
...
let level = 9; // fractal level
let length = 15; // step length
let axiom;
let rules;
let angle;
let sentence;
...
function setup() {
  ...
  strokeWeight(1);
  fill(random(palette));
  selectedShape = new Astroid(0, 0, length * shapeScale, radians(0));
