...
new p5(sa => {
    ...
    sa.preload = () => {
        // load the the shader
        shader0 = sa.loadShader('starter.vert', 'starter.frag');
    }
...
new p5(sb => {
    ...
    sb.preload = () => {
        // load the the shader
        shader1 = sb.loadShader('starter.vert', 'starter.frag');
    }
...
new p5(sc => {
    ...
    sc.preload = () => {
        // load the the shader
        shader2 = sc.loadShader('starter.vert', 'starter.frag');
    }
...
new p5(sd => {
    ...
    sd.preload = () => {
        // load the the shader
        shader3 = sd.loadShader('starter.vert', 'starter.frag');
    }
...
new p5(se => {
    ...
    se.preload = () => {
        // load the the shader
        shader4 = se.loadShader('starter.vert', 'starter.frag');
    }
...
new p5(sf => {
    ...
    sf.preload = () => {
        // load the the shader
        shader5 = sf.loadShader('starter.vert', 'starter.frag');
    }
...
//     sg.preload = () => {
//         // load the the shader
//         shader6 = sg.loadShader('starter.vert', 'starter.frag');
//     }
...
//     sh.preload = () => {
//         // load the the shader
//         shader7 = sh.loadShader(''starter.vert', 'starter.frag');
//     }
...
//             }
    ...
    wfc.clear = () => {
     ...
     wfc.share = () => {
      wfc.saveCanvas(canvas, 'paddle.png');
    }
    ...
    wfc.setup = () => {
        ...
        tiles[1] = new Tile(tileImages[1], ["AAAA", "ABBA", "AAAA", "AAAA"]);
        tiles[2] = new Tile(tileImages[2], ["ABBA", "AAAA", "AAAA", "ABBA"]);
        tiles[3] = new Tile(tileImages[3], ["AAAA", "ABBA", "AAAA", "ABBA"]);
        tiles[4] = new Tile(tileImages[4], ["AAAA", "AAAA", "ABBA", "AAAA"]);
        tiles[5] = new Tile(tileImages[5], ["ABBA", "AAAA", "ABBA", "AAAA"]);
        // tiles[5] = new Tile(tileImages[5], ["ABBA", "AAAA", "ABBA", "AAAA"]);
