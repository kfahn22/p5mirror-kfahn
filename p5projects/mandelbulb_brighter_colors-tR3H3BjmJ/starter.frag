   ...
   vec2 rm = RayMarch(ro, rd);
    ...
    float es = rm.y/100.0;
     ...
     // change cos to sine, and change number multiplied by es
      vec3 c1 = vec3( sin(es * 20.0 + 1.0*PI)*0.5 + 0.5 , sin(es * 20.0 + 1.0*PI)*0.5 + 0.5,  cos(es * 0.0 + 2.0*PI )*0.5 + 0.5  ); 
      
         //purple and green
     //vec3 c1 = vec3( tan(es * 30.0 + 2.0*PI)*0.5 + 0.5 , cos(es * 30.0 + 1.0*PI)*0.5 + 0.5,  tan(es * 30.0 )*0.5 + 0.5  ); 
   
   // vec3 c1 = vec3( sin(es * 30.0 + 2.0*PI)*0.5 + 0.5 , cos(es * 30.0 + 1.0*PI)*0.5 + 0.5,  sin(es * 30.0 )*0.5 + 0.5  ); 
     col = c1;
    }
