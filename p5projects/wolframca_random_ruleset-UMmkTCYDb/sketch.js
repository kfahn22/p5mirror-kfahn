...
// d, e - two different rulesets
// should be complementary rulesets to avoid random noise
// 78, 84
// 78, 92
// 69, 79
// 85, 103
function calculateState(a, b, c) {
  ...
  let ruleValue = randomRuleset(85,103);
  let ruleSet = ruleValue.toString(2).padStart(8, "0");
  return parseInt(ruleSet[value]);
}

// you can change the odds of favoring a ruleset
function randomRuleset(a, b) {
  let r = random(1);
  if (r > 0.7) {
    rule = a;
  } else {
