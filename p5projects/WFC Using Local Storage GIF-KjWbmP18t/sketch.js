// This sketch uses local storage to save the color choices and train track tiles.  It then loads the new tiles into the wave function collapse algorithm.
...
new p5(sa => {
    ...
    sa.setup = () => {
        ...
        r2Slider = sa.createSlider(0, 255, 125);
        g2Slider = sa.createSlider(0, 255, 125);
        b2Slider = sa.createSlider(0, 255, 125);
...
new p5(wfc => {
  ...
  if (wfc. key === 's') {
    ...
    wfc.startOver();
    wfc.saveGif('mySketch', frames, options);
    ...
    wfc.setup = () => {
        ...
        canvas = wfc.createCanvas(1200, 1200);
        canvas.parent(canvasDiv);
        instructDiv = wfc.createDiv().position(1510,10);
        let para1 = wfc.createP('Choose colors by moving r, g, b sliders');
        
        para1.style("font-size", "24px").parent(instructDiv);
        ...
        para2.style("font-size", "20px").parent(instructDiv);
        para2.style("color", "#fff");
        // para2.position(350, 70);
        button = wfc.createButton('CLEAR STORAGE').parent(instructDiv);;
        // button.position(350, 250);
        button.mousePressed(wfc.clear);
        button1 = wfc.createButton("SAVE ARTWORK").parent(instructDiv);;
