...
new p5(sa => {
    ...
    sa.preload = () => {
        // load the the shader
        shader0 = sa.loadShader('tubes.vert', 'tubes.frag');
    }
...
new p5(sb => {
    ...
    sb.preload = () => {
        // load the the shader
        shader1 = sb.loadShader('tubes.vert', 'tubes.frag');
    }
...
new p5(sc => {
    ...
    sc.preload = () => {
        // load the the shader
        shader2 = sc.loadShader('tubes.vert', 'tubes.frag');
    }
...
new p5(sd => {
    ...
    sd.preload = () => {
        // load the the shader
        shader3 = sd.loadShader('tubes.vert', 'tubes.frag');
    }
...
new p5(se => {
    ...
    se.preload = () => {
        // load the the shader
        shader4 = se.loadShader('tubes.vert', 'tubes.frag');
    }
...
new p5(sf => {
    ...
    sf.preload = () => {
        // load the the shader
        shader5 = sf.loadShader('tubes.vert', 'tubes.frag');
    }
...
//     sg.preload = () => {
//         // load the the shader
//         shader6 = sg.loadShader('tubes.vert', 'tubes.frag');
//     }
...
//     sh.preload = () => {
//         // load the the shader
//         shader7 = sh.loadShader('tubes.vert', 'tubes.frag');
//     }
...
new p5(wfc => {
    ...
    wfc.setup = () => {
        ...
        let para0 = wfc.createP('Digital Quilting: Open Tubes');
