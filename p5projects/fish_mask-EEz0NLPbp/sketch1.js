...
function setup() {
  ...
  //background(img);
  let palette = setPalette("blue_aqua");
  let palette2 = setPalette("purple");
  background(palette2[0]);

  // top
     topscales.push(new TearScales(0*width, -0.2 * height, 27.5, 1, palette));
  
  
  // right side
     rtscales.push(new TearScales(0.18* width, -0.41 * height, 27.5, 1, palette));
   rtscales.push(new TearScales(0.21* width, -0.38 * height, 26, 1, palette));
     rtscales.push(new TearScales(0.24* width, -0.41 * height, 26, 1, palette));
   rtscales.push(new TearScales(0.27 * width, -0.38 * height, 26, 1, palette));
  rtscales.push(new TearScales(0.3 * width, -0.37 * height, 25, 1, palette));
  rtscales.push(new TearScales(0.33 * width, -0.34 * height, 25, 1, palette));
    rtscales.push(new TearScales(0.36 * width, -0.31 * height, 25, 1, palette));
  rtscales.push(new TearScales(0.39 * width, -0.28 * height, 25, 1, palette));
    rtscales.push(new TearScales(0.42 * width, -0.23 * height, 20, 1, palette));
     rtscales.push(new TearScales(0.45 * width, -0.15 * height, 20, 1, palette));
  
  // left side
     lfscales.push(new TearScales(-0.18* width, -0.41 * height, 27.5, -1, palette));
   lfscales.push(new TearScales(-0.21* width, -0.38 * height, 26, -1, palette));
     lfscales.push(new TearScales(-0.24* width, -0.41 * height, 26, -1, palette));
   lfscales.push(new TearScales(-0.27 * width, -0.38 * height, 26, -1, palette));
   lfscales.push(new TearScales(-0.3 * width, -0.37 * height, 25, -1, palette));
  lfscales.push(new TearScales(-0.33 * width, -0.34 * height, 25, -1, palette));
    lfscales.push(new TearScales(-0.36 * width, -0.31 * height, 25, -1, palette));
  lfscales.push(new TearScales(-0.39 * width, -0.28 * height, 25, -1, palette));
    lfscales.push(new TearScales(-0.42 * width, -0.23 * height, 20, -1, palette));
     lfscales.push(new TearScales(-0.45 * width, -0.15 * height, 20, -1, palette));

  // eyes
  eyes.push(new Superellipse(-0.15 * width, -0.15 * height, 60, 0.8, 1, 2));
  eyes.push(new Superellipse(0.15 * width, -0.15 * height, 60, 0.8, 1, 2));

  translate(width / 2, height / 2);
 
    rigthtFishScales(0, 13, 36) // 0.24* width, -0.41 * height
 rigthtFishScales(1, 12, 35) // 0.24* width, -0.41 * height
  rigthtFishScales(2, 13, 35.2) // 0.24* width, -0.41 * height
   rigthtFishScales(3, 12, 35.2) // 0.27 * width, -0.38 * height
  rigthtFishScales(4, 12, 35); // 0.3 * width, -0.37 * height
  rigthtFishScales(5, 11, 35); // 1
  rigthtFishScales(6, 10, 35);  // 2
  rigthtFishScales(7, 9, 35);  // 3
  rigthtFishScales(8, 10, 26);
   rigthtFishScales(9, 7, 26);
  
      leftFishScales(0, 13, 36) // 0.24* width, -0.41 * height
 leftFishScales(1, 12, 35) // 0.24* width, -0.41 * height
  leftFishScales(2, 13, 35.2) // 0.24* width, -0.41 * height
   leftFishScales(3, 12, 35.2) // 0.27 * width, -0.38 * height
  leftFishScales(4, 12, 35); // 0.3 * width, -0.37 * height
  leftFishScales(5, 11, 35); // 1
  leftFishScales(6, 10, 35);  // 2
  leftFishScales(7, 9, 35);  // 3
  leftFishScales(8, 10, 26);
   leftFishScales(9, 7, 26);
...
//    fishScales(11, 7, 26);
  ...
  //   let n = int(scales.length / 2);

  //   for (let i = 0; i < n; i++) {
  //     scales[i].zigzag();
  //     scales[i].show();
  //   }
  //   for (let i = n + 1; i < scales.length; i++) {
  //     scales[i].reverseZigzag();
  //     scales[i].show();
  //   }
}

function rigthtFishScales(j, n, y) {
    push()
  for (let i = 0; i < n; i++) {
    rtscales[j].tear();
...
// function fishScales() {
//   scales.push(
//     new Scales(0.3 * width, -0.33 * height, 20.6, 15.4, 0.9, palette)
//   );
//   scales.push(new Scales(0.3 * width, -0.3 * height, 20.6, 15.4, 0.9, palette));
//   scales.push(
//     new Scales(0.35 * width, -0.29 * height, 18.4, 15.4, 0.9, palette)
//   );
//   scales.push(
//     new Scales(0.35 * width, -0.26 * height, 18.4, 15.4, 0.9, palette)
//   );
//   scales.push(
//     new Scales(0.4 * width, -0.25 * height, 18.4, 15.4, 0.9, palette)
//   );
//   scales.push(
//     new Scales(0.4 * width, -0.22 * height, 18.4, 15.4, 0.9, palette)
//   );
//   scales.push(
//     new Scales(0.45 * width, -0.19 * height, 18.4, 15.4, 0.9, palette)
//   );
//   scales.push(
//     new Scales(0.45 * width, -0.16 * height, 18.4, 15.4, 0.9, palette)
//   );
//   // Left Side
//   scales.push(
//     new Scales(-0.3 * width, -0.33 * height, 18.4, 15.4, 0.9, palette)
//   );
//   scales.push(
//     new Scales(-0.3 * width, -0.3 * height, 20.6, 15.4, 0.9, palette)
//   );
//   // scales.push(new Scales(0.35*width,
//   //   scales.push(new Scales(-0.35*width, -0.29*height, 18.4, 15.4, 0.9));
//   scales.push(
//     new Scales(-0.35 * width, -0.26 * height, 18.4, 15.4, 0.9, palette)
//   );
//   scales.push(
