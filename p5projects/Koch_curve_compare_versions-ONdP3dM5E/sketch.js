...
function preload() {
  ...
  // Art of Code
  //fragSource = loadStrings("AOC_koch.frag");
  // pedrotrschneider
   //fragSource = loadStrings("Schneider_koch.frag");
  // LYGIA
  //fragSource = loadStrings("snowflake.frag");
  fragSource = loadStrings("LYGIA_koch.frag");
  // Nimitz (@stormoid)
  //fragSource = loadStrings("Nimitz_koch.frag");
}
