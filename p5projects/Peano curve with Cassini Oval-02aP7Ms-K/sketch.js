...
function setup() {
  ...
  fractal = lsystem.peano;
  setRule(fractal);

  //strokeWeight(1.5);
  selectedShape = new CassiniOval(0, 0, length * shapeScale, 2, 2.5, 0);
  selectedShape.addPoints();
  push();
  translate(width * 0.075, height * 0.075);
...
function addPalettes() {
  ...
  paletteDropdown.option("purple_orange");
  ...
  // Set default palette
  paletteDropdown.selected("purple_orange");
...
function selectPalette() {
  ...
  switch (currentPalette) {
    case "purple_orange":
      url = "https://supercolorpalette.com/?scp=G0-hsl-FFA51F-FF931F-FF801F-FFCD1A-FFEC1F-991FFF-861FFF";
      break;
      case "purple_aqua":
      url =
