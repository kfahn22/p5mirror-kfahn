...
new p5(sa => {
    ...
    sa.preload = () => {
        // load the the shader
        shader0 = sa.loadShader('cross.vert', 'cross.frag');
    }
...
new p5(sb => {
    ...
    sb.preload = () => {
        // load the the shader
        shader1 = sb.loadShader('cross.vert', 'cross.frag');
    }
...
new p5(sc => {
    ...
    sc.preload = () => {
        // load the the shader
        shader2 = sc.loadShader('cross.vert', 'cross.frag');
    }
...
new p5(sd => {
    ...
    sd.preload = () => {
        // load the the shader
        shader3 = sd.loadShader('cross.vert', 'cross.frag');
    }
...
new p5(se => {
    ...
    se.preload = () => {
        // load the the shader
        shader4 = se.loadShader('cross.vert', 'cross.frag');
    }
...
new p5(sf => {
    ...
    sf.preload = () => {
        // load the the shader
        shader5 = sf.loadShader('cross.vert', 'cross.frag');
    }
...
new p5(sg => {
    ...
    sg.preload = () => {
        // load the the shader
        shader6 = sg.loadShader('cross.vert', 'cross.frag');
    }
...
//     sh.preload = () => {
//         // load the the shader
//         shader7 = sh.loadShader('cross.vert', 'cross.frag');
//     }
...
new p5(wfc => {
    ...
    wfc.setup = () => {
        ...
        let para0 = wfc.createP('Digital Quilting: Tribal');
        ...
        tiles[3] = new Tile(tileImages[3], ["BBBB", "AAAA", "BBBB", "AAAA"]);
