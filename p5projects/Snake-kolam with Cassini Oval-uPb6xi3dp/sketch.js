...
function setup() {
  ...
  strokeWeight(1.5);
  selectedShape = new CassiniOval(0, 0, length * shapeScale, 2.5, 2.25, 0);
...
function addPalettes() {
  ...
  // Set default palette
  paletteDropdown.selected("purple_aqua");
...
function reset() {
  ...
  selectedShape = new CassiniOval(0, 0, length * shapeScale, 2.25, 6, 0);
  selectedShape.addPoints();
  translate(width * 0.1, height * 0.1);
  background(0);
  setRule(fractal);
