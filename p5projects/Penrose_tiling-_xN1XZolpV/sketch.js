// https://computergraphics.stackexchange.com/questions/13903/l-system-to-generate-the-penrose-p3-tiling
// https://stackoverflow.com/questions/77946512/what-is-the-l-system-be-to-generate-an-penrose-p3-tiling
      ...
      if( step == 'F') {
        ...
        for(let j=0; j < this.repeats; j++) {
          ...
          // translate(0, -this.drawLength);
           line(0, 0, -this.drawLength, 0);
          noFill();
          translate(-this.drawLength, 0);
        }
        this.repeats = 1;
      }
      else if (step == '+') {
