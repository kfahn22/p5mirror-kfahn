...
void main()
{
   ...
   // Increase to zoom in
    ...
    if(d.x<MAX_DIST) {
        ...
        //float dd = d/MAX_DIST;
      // vec3 col = vec3(0.5-cos(dif * 20.0)/2.0,0.5-cos(dif * 30.0)/2.0,0.5-cos(dif * 40.0)/2.0);
 col = vec3(0.25-cos(d.x * 20.0)/2.0,0.25-cos(d.x * 21.0)/2.0,0.25-cos(d.x * 22.0)/2.0);
        //col = vec3(dif);
    }
