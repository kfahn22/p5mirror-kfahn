...
function preload() {
  ...
  fragSource = loadStrings("experiment.frag");
}
...
function draw() {
  ...
  //console.log(tan((5.0/6.0)*PI)*0.5);
  //console.log(cos((5.0/6.0)*PI));
  //console.log(sin((5.0/6.0)*PI));
  //console.log(tan((2.0/3.0)*PI) * 0.25);
  //console.log(cos((2.0/3.0)*PI))
  //console.log(sin((2.0/3.0)*PI));
  //console.log(tan((1.0/6.0)*PI) * 0.5)
