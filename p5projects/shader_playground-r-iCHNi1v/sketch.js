...
new p5(sa => {
    ...
    sa.preload = () => {
        // load the the shader
        shader0 = sa.loadShader('basic.vert', 'playground.frag');
    }
    ...
    sa.setup = () => {
        ...
        button0 = sa.createButton('SAVE TILE');
        ...
        button2 = sa.createButton("Add Grids");
        button2.position(500,500);
        button2.mousePressed(sa.addGrids);
        ...
        // radio.position(250, 550);
        // radio.option('0.0',' Add Grid Lines');
        // radio.option('1.0', 'Turn off Grid Lines');
        // radio.selected('1.0');
    ...
    sa.draw = () => {
        ...
        shader0.setUniform('grids', grids);
        sa.shader(shader0);
...
new p5(sb => {
    ...
    sb.preload = () => {
        // load the the shader
        shader1 = sb.loadShader('basic.vert', 'playground.frag');
    }
...
new p5(sc => {
    ...
    sc.preload = () => {
        // load the the shader
        shader2 = sc.loadShader('basic.vert', 'playground.frag');
    }
...
new p5(sd => {
    ...
    sd.preload = () => {
        // load the the shader
        shader3 = sd.loadShader('basic.vert', 'playground.frag');
    }
