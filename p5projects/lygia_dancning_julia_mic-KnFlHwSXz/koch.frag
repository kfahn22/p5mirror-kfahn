...
void main(void) {
    ...
    st = koch3SDF(st);
    //st *= Rot(t*PI);  // add rotation
    float d = juliaSDF(st*6., u_vol, vec2(u_vol*0.5), vec2(0.27334, .00742));
    
    // color.rgb = vec3(0.45-cos(d * 20.0)/2.0,0.45-cos(d * 30.0)/2.0,0.45-cos(d * 40.0)/2.0);
    color.rgb = vec3(0.75-cos(d * 30.0)/2.0,0.5-cos(d * 20.0)/2.0,1.0-cos(d * 20.0)/2.0);
