...
// Heart curve equation adapted from http://www.mathematische-basteleien.de/heart.html
// This one renders slowly
...
function setup() {
  ...
  h2 = new Heart2(width * 1 / 2, height * 3 / 4, windowHeight*0.10);
}
