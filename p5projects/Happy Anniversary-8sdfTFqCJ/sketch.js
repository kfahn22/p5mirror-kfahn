...
//             }
    ...
    wfc.setup = () => {
        ...
        let para0 = wfc.createP('Run program to see your special message.');
        ...
        tiles[1] = new Tile(tileImages[1], ["A", "A", "A", "B"]);
        tiles[2] = new Tile(tileImages[2], ["A", "A", "C", "A"]);
        tiles[3] = new Tile(tileImages[3], ["A", "A", "D", "A"]);
        tiles[4] = new Tile(tileImages[4], ["C", "A", "A", "A"]);
        tiles[5] = new Tile(tileImages[5], ["D", "A", "A", "A"]);
