...
new p5(wfc => {
    ...
    wfc.setup = () => {
        ...
        tiles[1] = new Tile(tileImages[1], ["AAAA", "AAAA", "ABBA", "AAAA"]);
        tiles[2] = new Tile(tileImages[2], ["AAAA", "ABBAA", "AAAA", "AAAA"]);
        tiles[3] = new Tile(tileImages[3], ["ABBA", "AAAA", "ABBA", "AAAA"]);
